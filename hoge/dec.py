...
>>> encoder_inputs
<tf.Tensor '...' shape=(4, 111) dtype=int32>
...
>>> encoder_emb_inputs
<tf.Tensor '...' shape=(4, 111, 8) dtype=float32>
...
>>> encoder_outputs
<tf.Tensor '...' shape=(4, 111, 6) dtype=float32>
>>> encoder_state
LSTMStateTuple(c=<tf.Tensor '...' shape=(111, 6) dtype=float32>, h=<tf.Tensor '...' shape=(111, 6) dtype=float32>)

>>> decoder_inputs = tf.placeholder(tf.int32, shape=(decoder_length, batch_size), name="decoder_inputs")
>>> decoder_inputs
<tf.Tensor '...' shape=(5, 111) dtype=int32>

>>> decoder_lengths = tf.placeholder(tf.int32, shape=(batch_size), name="decoer_length")
>>> decoder_lengths
<tf.Tensor '...' shape=(111,) dtype=int32>
...
>>> decoder_emb_inputs
<tf.Tensor '...' shape=(5, 111, 8) dtype=float32>
...
>>> final_outputs
BasicDecoderOutput(rnn_output=<tf.Tensor '...' shape=(111, ?, 9) dtype=float32>, sample_id=<tf.Tensor '...' shape=(111, ?) dtype=int32>)
>>> _final_state
LSTMStateTuple(c=<tf.Tensor '...' shape=(111, 6) dtype=float32>, h=<tf.Tensor '...' shape=(111, 6) dtype=float32>)
